          ...
          <div className="container">
            <div className="flex flex-wrap gap-x-6 gap-y-1">
              {[
                ...
                { role: "後援", name: "日田市・日田商工会議所・一般社団法人日田市観光協会" },
              ].map((o) => (
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              {
                role: "後援",
                name: "日田市・日田商工会議所・一般社団法人日田市観光協会",
          ...
          <FadeIn delay={0.1}>
            ...
            >
              {[
                ...
                { label: "後援", value: "日田市、日田商工会議所、一般社団法人日田市観光協会" },
              ].map((row, i) => (
                <div
                  key={row.label}
                  className="flex"
          ...
          <FadeIn delay={0.1}>
            <div className="max-w-2xl space-y-0">
              {[
                ...
                { date: "2026.07.30", tag: "後援決定", title: "日田市・日田商工会議所・一般社団法人日田市観光協会の後援決定のお知らせ" },
              ].map((item, i) => (
                <div
                  key={i}
