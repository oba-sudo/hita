        ...
        <div className="mx-auto max-w-[1180px]">
          <div className="grid gap-10 lg:grid-cols-[.78fr_1.22fr] lg:gap-16">
            <div>
              ...
              <p className="mt-5 flex items-start gap-2 font-sans-jp text-sm leading-7 text-white/58"><MapPin size={16} className="mt-1 shrink-0 text-[#F43F8E]" />〒877-0054<br />大分県日田市高瀬6979</p>
              <a href={MAP_URL} target="_blank" rel="noopener noreferrer" className="mt-7 inline-flex items-center gap-2 rounded-full border border-white/20 px-6 py-3 font-sans-jp text-sm text-white transition-colors hover:bg-white/10">Googleマップで開く <ExternalLink size={14} /></a>

              <div className="mt-12 space-y-px bg-white/10">
                <div className="bg-[#07091d] p-6">
            ...
            <div className="space-y-5">
              <div className="relative min-h-[280px] overflow-hidden border border-white/10 md:min-h-[360px]">
              ...
              <div className="min-h-[500px] overflow-hidden border border-white/10 bg-white/5">
                <iframe
