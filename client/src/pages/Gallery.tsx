...
const GALLERY_IMAGES = [
  { id: 1, src: "/manus-storage/hero_97225277.jpg", alt: "日田イルミナージュ2026 メインビジュアル", caption: "会場全景イメージ" },
  { id: 2, src: "/manus-storage/gallery1_9912daf3.jpg", alt: "イルミネーション1", caption: "光のトンネル" },
  { id: 3, src: "/manus-storage/gallery2_8f991659.jpg", alt: "イルミネーション2", caption: "メインゲート" },
  { id: 4, src: "/manus-storage/gallery3_77c209d6.jpg", alt: "イルミネーション3", caption: "水辺の光景" },
  { id: 5, src: "/manus-storage/hero_sp_d2322500.jpg", alt: "イルミネーション4", caption: "夜の会場" },
  { id: 6, src: "/manus-storage/gallery1_9912daf3.jpg", alt: "イルミネーション5", caption: "フォトスポット" },
];
...
export default function Gallery() {
  ...
  return (
    <PageLayout>
      <PageHero en="GALLERY" ja="ギャラリー" sub="日田イルミナージュのイメージ画像をご覧ください。" bgImage="/manus-storage/hero_97225277.jpg" />
      <div className="pb-20 bg-[#F7F1E5]">
        <div className="max-w-[1200px] mx-auto px-4 -mt-4">
          <p className="mt-6 mb-4 text-xs text-[#10243E]/50 font-sans-jp">※ 掲載画像はイメージです。実際の演出とは異なる場合があります。</p>
