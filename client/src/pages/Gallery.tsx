...
const GALLERY_IMAGES = [
  ...
  { id: 2, src: "/manus-storage/gallery1_b05537d1.jpg", alt: "イルミネーション1", caption: "光のトンネル" },
  { id: 3, src: "/manus-storage/gallery2_3f1cfbd2.jpg", alt: "イルミネーション2", caption: "メインゲート" },
  { id: 4, src: "/manus-storage/gallery3_a3ce42f5.jpg", alt: "イルミネーション3", caption: "水辺の光景" },
  { id: 5, src: "/manus-storage/hero_sp_d2322500.jpg", alt: "イルミネーション4", caption: "夜の会場" },
  { id: 6, src: "/manus-storage/gallery1_b05537d1.jpg", alt: "イルミネーション5", caption: "フォトスポット" },
];
