...
const OVERVIEW_ROWS = [
  ...
  { label: "会場", value: "サッポロビール九州日田工場（大分県日田市）" },
...
const ATTRACTION_METHODS = [
  ...
  {
    title: "県外・インバウンド向け",
    items: ["日田市観光協会・宿泊施設連携", "旅行会社・観光メディア", "外国語WEBサイト", "福岡空港利用者向けPR"],
  },
];
      ...
      <section className="relative min-h-[90svh] flex flex-col justify-end pt-14 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 pb-12 w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-10">
            <a href="/manus-storage/sponsor_guide_hita.pdf" download className="flex items-center justify-center gap-2 bg-[#C8A35A] text-[#0a1432] font-bold text-sm px-6 py-3 rounded font-sans-jp active:scale-95 transition-transform">
