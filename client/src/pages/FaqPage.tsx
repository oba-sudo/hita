...
const FAQS = [
  ...
  { q: "会場時間と点灯時間は何時ですか？", a: "会場時間は17:00〜21:30、点灯時間は17:30〜21:30です。雨天決行です。" },
  { q: "雨の日も開催しますか？", a: "雨天でも開催予定です。天候や安全上の理由により内容変更・中止となる場合は、公式サイトのお知らせでご案内します。" },
  { q: "開催中止や変更の場合はどこで確認できますか？", a: "公式サイトのお知らせおよび公式Instagramでご案内します。" },
  { q: "会場はどこですか？", a: "サッポロビール九州日田工場（〒877-0054 大分県日田市高瀬6979）です。" },
  { q: "駐車場はありますか？", a: "会場併設の無料駐車場を150台ご用意しています。台数に限りがあるため、混雑時は時間に余裕をもってお越しください。" },
  { q: "駐車料金はかかりますか？", a: "会場併設駐車場は無料です。" },
  { q: "車で会場まで直接行くことはできますか？", a: "可能です。日田ICから約10分、会場併設駐車場をご利用いただけます。" },
  { q: "車椅子での入場は可能ですか？", a: "車椅子でご入場いただけます。会場内は概ね平坦ですが、一部に砂利道があります。" },
  { q: "ベビーカーでの入場は可能ですか？", a: "ベビーカーでご入場いただけます。会場内は概ね平坦ですが、一部に砂利道があります。" },
  { q: "再入場はできますか？", a: "入場後の再入場はできません。" },
  { q: "愛犬などのペットを連れて入場できますか？", a: "介助犬を除き、ペットのご入場はできません。" },
  { q: "会場内で写真や動画を撮影できますか？", a: "個人でお楽しみいただく範囲で撮影できます。三脚・一脚をご使用の際は、ほかのお客様のご迷惑とならないようご配慮ください。商用目的での撮影をご希望の場合は、事前にお問い合わせください。" },
  { q: "飲食できる場所はありますか？", a: "飲食は日田森のビール園のみでご利用いただけます。" },
  { q: "トイレはありますか？", a: "トイレは会場の外に設置しています。" },
  { q: "どのような服装がおすすめですか？", a: "屋外イベントのため、冬の夜間は冷え込みます。暖かい服装と、歩きやすい靴でのご来場をおすすめします。" },
  { q: "入場料金を教えてください。", a: "大人（中学生以上）2,000円、子ども（1歳〜小学生）1,000円です。0歳のお子さまは無料です。" },
  { q: "当日券は購入できますか？", a: "会場受付で購入できます。支払いは現金のみです。" },
  { q: "WEBチケットはありますか？", a: "前売り券のみWEBチケットを販売します。楽天・KKDAYで購入でき、購入先は随時追加予定です。" },
