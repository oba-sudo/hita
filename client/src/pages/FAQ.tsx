...
export default function FAQ() {
  ...
  return (
    <PageLayout>
      <PageHero en="FAQ" ja="よくある質問" sub="お客様からよくいただくご質問をまとめました。" bgImage="/manus-storage/gallery3_77c209d6.jpg" />
      <div className="pb-20 bg-[#F7F1E5]">
        <div className="max-w-3xl mx-auto px-4 -mt-4">
          <div className="mt-6 space-y-3">
            {FAQ_ITEMS.map((item, i) => (
              <div key={i} className="bg-white rounded-2xl shadow-sm border border-[#e8e0d0] overflow-hidden">
                <button
                  className="w-full flex items-center justify-between gap-3 px-6 py-4 text-left"
                  onClick={() => setOpen(open === i ? null : i)}
                >
                  <span className="font-sans-jp font-bold text-[#10243E] text-sm leading-relaxed flex-1">
                ...
                {open === i && (
                  <div className="px-6 pb-5 pt-0">
                    <div className="border-t border-[#e8e0d0] pt-4">
                      <p className="font-sans-jp text-sm text-[#10243E]/80 leading-relaxed">
          ...
          <div className="mt-10 bg-[#10243E] rounded-2xl p-6 text-center">
            ...
            <a href="/contact" className="inline-flex items-center gap-2 bg-[#C8A35A] hover:bg-[#b8924a] text-[#10243E] font-bold px-6 py-3 rounded-xl font-sans-jp text-sm transition-all active:scale-95">
              お問い合わせフォームへ
            </a>
          </div>
        </div>
