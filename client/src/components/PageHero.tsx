...
export default function PageHero({ en, ja, sub, bgImage }: PageHeroProps) {
  return (
    <section className="relative min-h-[390px] overflow-hidden bg-[#030513] pt-24 md:min-h-[520px] md:pt-36">
      {bgImage && (
      ...
      <div className="relative z-10 mx-auto flex min-h-[266px] max-w-[1320px] flex-col justify-end px-5 pb-12 md:min-h-[370px] md:px-8 md:pb-20">
        ...
        <h1 className="font-serif-jp text-[clamp(2.15rem,7vw,5.6rem)] font-semibold leading-[1.12] tracking-[-.04em] text-white">{ja}</h1>
        {sub && <p className="mt-4 max-w-2xl font-sans-jp text-[15px] leading-7 text-white/70 md:mt-5 md:text-base md:leading-8">{sub}</p>}
      </div>
    </section>
  );
}
